...
type SQSConfig struct {
	...
	MessageFormat  string   `help:"The format of the SQS messages.\n'plain' SQS messages contain a plain S3 path.\n'sns' SQS messages are generated by a SNS notification.\n's3::ObjectCreated' messages are generated by a S3 bucket notification" default:"sns"`
...
func (cfg *SQSConfig) fillDefaults() error {
	...
	case sqsFormatS3ObjectCreated:
		cfg.format = sqsFormatS3ObjectCreated
	default:
